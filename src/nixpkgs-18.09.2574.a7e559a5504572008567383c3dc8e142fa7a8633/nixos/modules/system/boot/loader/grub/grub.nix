  ...
  grubConfig = args:
    ...
    { splashImage = f cfg.splashImage;
      ...
      storePath = config.boot.loader.grub.storePath;
			...
			subroot_path = config.subroot.path;
			subboot_path = config.subboot.path;
			subboot_mnt_enabled = config.subboot.mnt.enabled;
			subboot_mnt_src = config.subboot.mnt.src;
			subboot_mnt_dest = config.subboot.mnt.dest;
			subboot_mnt_opt = config.subboot.mnt.opt;
...

{
  ...
  options = {
    ...
    boot.loader.grub = {
      ...
      #  example = "/mach/nixos";
      #  type = types.str;
      #  description = "Subdirectory path on the device to mount as the rootfs.";
      #};
